...
if __name__ == "__main__":
    ...
    if (options["visualize"]):
        ...
        test_re = (torch.ones_like(test_x) * 1 /
                   DeepCFD.nu).to(options["device"])
        visualize1DBurgers(time_label, test_x, test_re, options, DeepCFD, BurgersExact, xBounds, tBounds)

# %run applications/physicsinformedNN.py --epochs 500 --batch-size 32 --visualize True